...
$path = "../img/birthCertificates/" . $_SESSION['username'];
...
move_uploaded_file($_FILES['fileName']['tmp_name'],   '../img/birthCertificates/' . $_SESSION['username'] . "/" . $_FILES['fileName']['name']);
...
$dbConn = getConnection();
        ...
        $sql = "UPDATE users SET birthCertDir='" . $_FILES['fileName']['name'] . "'WHERE username='" .$_SESSION['username']. "'";
